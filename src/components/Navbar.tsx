  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      dropdown: [
        ...
        { href: '/house-number', label: 'House Number', description: 'Your home\'s vibration' },
        { href: '/karmic-lesson', label: 'Karmic Lesson Numbers', description: 'Missing numbers in your name' },

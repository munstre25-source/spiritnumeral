...
export async function generateStaticParams() {
  return getStaticParamsForRoute('manifestation');
}
      ...
      <main className="min-h-screen bg-page text-primary pt-32 md:pt-48 p-8 font-sans">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <section className="grid gap-6 md:grid-cols-2">
            <div className="p-8 rounded-3xl bg-card border border-default backdrop-blur-sm transition-all hover:border-violet-500/30">

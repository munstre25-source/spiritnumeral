    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-100 pt-28 md:pt-36 pb-20 px-6 md:px-10">
      ...
      <section className="max-w-6xl mx-auto grid gap-6 md:grid-cols-2">
        {lifePaths.map((path) => (
          <article
            key={path.path}
            className="p-6 md:p-7 rounded-3xl bg-zinc-900/60 border border-zinc-800 hover:border-amber-500/40 transition shadow-lg"
          >
            <div className="flex items-center justify-between mb-4">
              <div className="text-sm uppercase tracking-[0.2em] text-amber-400 font-semibold">
                Life Path {path.path}
              </div>
            ...
            <p className="text-zinc-200 font-medium mb-3">{path.traits}</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-zinc-300">
              <div className="rounded-2xl bg-zinc-950/60 border border-zinc-800 p-4">
                <div className="text-amber-400 font-semibold mb-1">Love</div>
                <p className="text-zinc-300 leading-relaxed">{path.love}</p>
              </div>
              <div className="rounded-2xl bg-zinc-950/60 border border-zinc-800 p-4">
                <div className="text-amber-400 font-semibold mb-1">Career</div>
                <p className="text-zinc-300 leading-relaxed">{path.career}</p>
              </div>
            </div>

...
export default function MeaningHubPage() {
  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-zinc-50 pt-28 md:pt-36 pb-24 px-6 md:px-10">
      ...
      <section className="max-w-6xl mx-auto grid gap-6 md:grid-cols-2 mb-16">
        <article className="p-6 rounded-3xl bg-zinc-900/60 border border-zinc-800 hover:border-amber-500/40 transition shadow-lg">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-4 py-3 rounded-xl border border-zinc-800 text-zinc-200 hover:border-amber-500/60 transition"
            >
              Why am I seeing 111?
            </Link>
          </div>
        ...
        <article className="p-6 rounded-3xl bg-zinc-900/60 border border-zinc-800 hover:border-amber-500/40 transition shadow-lg">
          ...
          <h2 className="text-2xl font-bold text-amber-50 mb-2">Life Path meanings (1-9)</h2>
          <p className="text-zinc-300 leading-relaxed mb-4">
      ...
      <section className="max-w-6xl mx-auto space-y-10">
        <div>
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-amber-50 mb-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {gscCards.map((item) => (
              <article
                key={item.number}
                className="p-5 rounded-3xl bg-zinc-900/60 border border-zinc-800 hover:border-amber-500/40 transition shadow-lg flex flex-col gap-3"
              >

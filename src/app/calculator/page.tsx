      ...
      <div className="max-w-4xl mx-auto">
        ...
        <nav className="text-sm text-zinc-400 mb-6" aria-label="Breadcrumb">
          <ol className="flex items-center gap-2">
            ...
            <li className="text-amber-200">Numerology Calculator</li>
          </ol>
        </nav>
        ...
        <div className="mt-10 p-8 rounded-3xl bg-zinc-900/30 border border-zinc-800">
          ...
          <dl className="space-y-6">
            {faqItems.map((item) => (
              <div key={item.question} className="border-b border-zinc-800 pb-6 last:border-b-0 last:pb-0">
                <dt className="text-lg font-semibold text-amber-200">{item.question}</dt>
